...
class SondyQ2AudioProcessor : public juce::AudioProcessor
{
public:
    SondyQ2AudioProcessor();
    ~SondyQ2AudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SondyQ2AudioProcessor)
};